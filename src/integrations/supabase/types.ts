export interface Database {
  public: {
    Tables: {
      produtos_mestre: {
        Row: { id: string; nome: string; categoria: string | null; tipo: "comprado" | "montado"; custo_manual: number | null; preco_manual: number | null; codigo: string | null; unidade: string | null; unidade_secundaria: string | null; fator_conversao: number | null; created_at: string };
        Insert: { id?: string; nome: string; categoria?: string | null; tipo?: "comprado" | "montado"; custo_manual?: number | null; preco_manual?: number | null; codigo?: string | null; unidade?: string | null; unidade_secundaria?: string | null; fator_conversao?: number | null; created_at?: string };
